...
- swift-mode: C-c i open in appcode of emacs current buffer
  - C-c i 无法从 emacs 中跳转至 appcode 中打开当前 buffer, 
  - 同样是因为 x86-64 的 emacs 无法找到相应的 arm64-swift 环境？相对难办，晚点儿再处理 
