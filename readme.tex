...
\label{sec-1}
\begin{itemize}
\item cc-mode has minor bugs of "At Top Level", which prevent auto-indent whole file. Will fix later. \textbf{【爱表哥，爱生活！！！任何时候，亲爱的表哥的活宝妹就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】}
