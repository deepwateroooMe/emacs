...
\section{TODOs: tracing bugs of emacs 28.1 custom-build version}
\label{sec-1}
\subsection{invalid time specification: sr-speedbar on MacOS}
\label{sec-1-1}

\includegraphics[width=.9\linewidth]{./pic/readme_20230208_163916.png}
\begin{itemize}
